          ...
          <button
            ...
            className={cn(
              ...
              isOpen 
                ...
                : "bg-muted text-muted-foreground hover:bg-muted/80 hove:text-foreground"
            )}
          >
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="absolute z-[60] bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-[200px]"
              >
